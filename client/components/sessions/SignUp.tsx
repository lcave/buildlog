...
function SignUp({ show = false, handleClose, swapForm, ...props }) {
    ...
    return (
        <div className="p-10 bg-white rounded-lg text-center shadow-lg relative">
            ...
            <a className="text-blue-700 cursor-pointer hover:underline" onClick={() => swapForm()}>Already a member? <strong>LOG IN</strong></a>
        </div>
    )
}
